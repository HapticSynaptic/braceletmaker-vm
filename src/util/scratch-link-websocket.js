...
class ScratchLinkWebSocket {
    ...
    open () {
        switch (this._type) {
        case 'BLE':
            this._ws = new WebSocket('wss://127.0.0.1:20111/braceletmaker/ble');
            break;
        case 'BT':
            this._ws = new WebSocket('wss://127.0.0.1:20111/braceletmaker/bt');
            break;
        case 'SERIALPORT':
            this._ws = new WebSocket('wss://127.0.0.1:20111/braceletmaker/serialport');
            break;
        default:
